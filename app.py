...
STORIES = {
    ...
    3: {"title": "☀️ 第二天：请选择今日安排", "choices": [
        ("去通告现场探班", "『台词我都记熟啦，随时可以开始！』", 20),
        ("在酒店休息对剧本", "『有你陪着对剧本，效率都变高了呢。』", 15),
        ("秘密约会，小心被发现", "『难得的休息日，今天听你的安排！』", 18)
    ]},

    4: {"title": "🎬 丈君·近距离对峙：大阪男人的直球", "choices": [
        ("假装板起脸：『身为艺人要稳重！』", "『对别人我稳重，对你嘛……我只想做最真实的自己。』", 25),
        ("被逗笑：『好啦，不跟你贫嘴了。』", "『别走嘛，多看看我，今天可是特意为你练习了帅气眼神。』", 20),
    ...
    "米七": {
        ...
        "在日学生or打工人": {
            ...
            6: {"title": "🎬 米七·告白结局：异国纯白的浪漫长跑", "choices": [
                ("主动牵手：『长腿王子的心意，我收下了。』", "『太幸福了！从今天起，你就是我异国恋里的唯一女主角！』", 35),
...
if st.session_state.random_event:
    ...
    if "文春炮" in current_event_title:
        if "🕵️‍♂️ 黑色鸭舌帽" in st.session_state.inventory:
            ...
            st.session_state.total_score -= 30  # 没道具就扣分
