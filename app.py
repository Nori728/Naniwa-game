...
# -----------------------------------------------------------------------------
# 1. 页面基本配置与安全加载 (支持本地路径与 https 网址)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# 2. 成员与身份数据配置 (已将默认图片全部安全替换为网络示范网址)
# -----------------------------------------------------------------------------
DEFAULT_URL = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTk87Ir-K55m72_7D5uRJNcmWnL0tWQ3Alda_nNY4B4VQORJJi9CfUHHLcUYH7-vOcFsfLJEyCDSOBEkZ3ecCPU_2fyPSyc0FeVVIjymT0&s=10"

MEMBERS = {
    "丈君": {"nick": "丈君", "trait": "搞笑又可靠的大哥哥", "img": DEFAULT_URL, "color": "💙 蓝色"},
    "大酱": {"nick": "大酱", "trait": "热情太阳般的 C 位", "img": DEFAULT_URL, "color": "🔴 红色"},
    "布丁": {"nick": "布丁", "trait": "温柔体贴又吃得超香的队长", "img": DEFAULT_URL, "color": "💚 绿色"},
    "高恭": {"nick": "高恭", "trait": "自恋又亚撒西的八嘎帅哥，实则运动超强", "img": DEFAULT_URL, "color": "💜 紫色"},
    "流星": {"nick": "流星", "trait": "眼睛会闪光的小恶魔", "img": DEFAULT_URL, "color": "🧡 橙色"},
    "米七": {"nick": "米七", "trait": "高挑帅气的长腿王子", "img": DEFAULT_URL, "color": "💖 粉色"},
    "谦杜": {"nick": "谦杜", "trait": "时尚又有主见的小恶魔末子", "img": DEFAULT_URL, "color": "💛 黄色"},
}
...
if st.session_state.page == "home":
    safe_audio("audio/bgm_home.mp3")  # 首页专属 BGM
...
# -----------------------------------------------------------------------------
# B. 剧情互动 (1~3幕多选项分支，按幕展示对应图片与 BGM)
# -----------------------------------------------------------------------------
