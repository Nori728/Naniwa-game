...
# -----------------------------------------------------------------------------
# 2. 7人全员基础数据源与写真 (确保每个成员的字段结构完全统一且无语法错误)
# -----------------------------------------------------------------------------
MEMBERS = {
    "丈君": {
        "trait": "搞笑又可靠的大哥哥", 
...
if st.session_state.step == 0:
    ...
    selected_role = st.selectbox("身份列表", ROLES, key="role_select_box")
...
# -----------------------------------------------------------------------------
    ...
    chosen_member = st.selectbox("成员列表", member_keys, key="member_select_box")
    
    # 安全获取字典数据
    m_info = MEMBERS.get(chosen_member, MEMBERS["丈君"])
...
# -----------------------------------------------------------------------------
    ...
    m_info = MEMBERS.get(member, MEMBERS["丈君"])
...
# -----------------------------------------------------------------------------
    ...
    st.markdown(
        ...
        <div class="card-box" style="text-align: center;">
            ...
            <p style="margin-top: 15px; font-weight: bold; font-size: 1.
