    ...
    if role == "经纪人":
        if act == 1:
            return {
                ...
                "img": "images/act1_backstage.jpg",   # 第一幕场景图片
                "bgm": "audio/act1_bgm.mp3",          # 第一幕背景音乐
                "choices": [
            ...
            return {
                ...
                "img": "images/act2_stage.jpg",       # 第二幕场景图片
                "bgm": "audio/act2_bgm.mp3",          # 第二幕背景音乐
                "choices": [
            ...
            return {
                ...
                "img": "images/act3_night.jpg",       # 第三幕场景图片
                "bgm": "audio/act3_bgm.mp3",          # 第三幕背景音乐
                "choices": [
        ...
        if act == 1:
            ...
            return {
                ...
                "bgm": "audio/act3_bgm.mp3",
                "choices": [
                    {"label": "🅰️ 买两罐热可可，碰到了彼此的手指。", "dialogue": f"『握着热可可……感觉整import streamlit as st
import random
import os
    ...
    if role == "经纪人":
        ...
        if act == 1:
            ...
            return {
                ...
                "bgm": "audio/act3_bgm.mp3",
                "choices": [
                    {"label": "🅰️ 买两罐热可可，碰到了彼此的手指。", "dialogue": f"『握着热可可……感觉整
